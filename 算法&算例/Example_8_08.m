...
second = 0;
depart = [planet_id year month day hour minute second];
[month_name1, planet_name1] = month_planet_names(month, planet_id);
%...Arrival
planet_id = 4;
year = 1997;
month = 9;
...
second = 0;
arrive = [planet_id year month day hour minute second];
[month_name2, planet_name2] = month_planet_names(month, planet_id);
%...
%...Algorithm 8.2:
